...
public class Constants {
	...
	public static final String CONVERSION_RATE_RESOURCE_KEY = "ConversionRateResource";
	public static final String CONVERSION_RATE_RESOURCE_VALUE = "ConversionRate.xml";
